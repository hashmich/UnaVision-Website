...
<div class="text-column">
    ...
    <p>
        ...
        Die Erforschung enkeltauglichen Lebens und Wirtschaftens und
        Stärkung des sozialen Zusammenhalts sind wichtige Anliegen.
    </p>

    <p>
        Die Standorte von UnaVision sind <em>UnaVillages</em>.<br>
        Mehr zu <a href="<?php echo Router::url('unavillage'); ?>">UnaVillages</a>.
    </p>
</div>